...
{% assign archive_pages = site.pages | where_exp: "page", "page.path contains 'Archive/'" | where_exp: "page", "page.name == 'index.md' and page.path != 'Archive/index.md'" | sort: "path" | reverse %}
